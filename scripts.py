...
╭────[🔅Rᴇɴᴀᴍᴇʀ Bᴏᴛ🔅]───⍟
│
├<b>📢 Developer : <a href='https://t.me/TMC_BOTX'>𝓣𝓜𝓒_𝓑𝓞𝓣𝓧</a></b>
│
├<b>👨‍💻 Support : <a href='https://t.me/TMC_BOTX_Group'>𝓣𝓜𝓒_𝓑𝓞𝓣𝓧_𝓖𝓡𝓞𝓤𝓟</a></b>
│
╰──────[Thanks 😊]───⍟"""
    ...
    UPLOAD_SUCCESS = "<u><i>Tʜᴀɴᴋᴀ Fᴏʀ Usɪɴɢ ᴍᴇ❤ </i></u>"
    ...
    CONTACT_MY_DEVELOPER = "<i>Something Wrong Contact in Support Group 😑</i>"
    START_TEXT = "<i>This is a Fastest File Renamer and Converter Bot With Permanant Thumbnail Support💯</i>"
    UPGRADE_TEXT = "<b>To upgrade your subscription <a href='https://t.me/TMC_BOTX_Group'>[ Click Here]</a></b>"
